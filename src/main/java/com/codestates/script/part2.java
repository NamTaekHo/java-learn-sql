...
public class part2 {
  ...
  */
  public static final String PART2_2 = "SELECT user.name FROM user;";
  ...
  */
  public static final String PART2_3 = "INSERT INTO user (name, email) VALUES ('taekho', 'taekho1225@gmail.com');";
  ...
  */
  ...
  public static final String PART2_6 = "SELECT content.title FROM content;";
  ...
  */
  public static final String PART2_9 = "UPDATE content SET body = 'database is very easy' WHERE content.title = 'database homework';";
  ...
  */
  public static final String PART2_10 = "INSERT INTO content (title, body, userId) VALUES ('luckytitle', 'luckybody', 1);";
}
