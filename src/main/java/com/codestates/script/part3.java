...
public class part3 {
  ...
  */
  ...
  public static final String PART3_2_1 = "SELECT category.id, category.name FROM category;";
  ...
  */
  public static final String PART3_2_6 = "SELECT category.name FROM user JOIN content ON user.id = content.userId JOIN content_category ON content.id = content_category.contentId JOIN category ON content_category.categoryId = category.id WHERE user.name = 'minsanggu';";
  ...
  */
  public static final String PART3_2_8 = "SELECT content.title, content.body, content.created_at, user.name FROM user JOIN content ON user.id = content.userId JOIN content_category ON content.id = content_category.contentId JOIN category ON content_category.categoryId = category.id WHERE category.name = 'java';";
  ...
  */
  public static final String PART3_2_10 = "SELECT user.name, COUNT(content.id) AS ContentCount " +
          "FROM user " +
